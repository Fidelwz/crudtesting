                          ...
                          <div class="border-b border-gray-900/10 pb-12 dark:border-gray-700 ">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                              <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                  <input value="{{old('projectName', $data->projectName)}}" required type="text" name="projectName" id="first-name" autocomplete="given-name"
                              ...
                              <div class="sm:col-span-3">
                                <label for="last-name"
                                  ...
                                  fondos</label>
                                <div class="mt-2">
                                  <input value="{{old('sourceOfFunds', $data->sourceOfFunds)}}" required type="text" name="sourceOfFunds" id="last-name" autocomplete="family-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                              </div>
                              ...
                              <div class="sm:col-span-3">
                                <label for="street-address"
                                  ...
                                  planificado $</label>
                                <div class="mt-2">
                                  <input value="{{old('plannedAmount', $data->plannedAmount)}}" required type="number" min="0" step=".01" name="plannedAmount" id="street-address"
                              ...
                              <div class="sm:col-span-3">
                                <label for="street-address"
                                  ...
                                  patrocinado $</label>
                                <div class="mt-2">
                                  <input value="{{old('sponsoredAmount', $data->sponsoredAmount)}}"  required type="number" min="0" step=".01" name="sponsoredAmount" id="street-address"
                                    autocomplete="street-address"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                              </div>
                              ...
                              <div class="sm:col-span-2 sm:col-start-1">
                                ...
                                <div class="mt-2">
                                  <input  value="{{old('amountOwnFunds', $data->amountOwnFunds)}}" required type="number" min="0" step=".01" name="amountOwnFunds" id="city"
